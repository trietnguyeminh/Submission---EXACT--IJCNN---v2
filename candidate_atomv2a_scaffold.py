...
import re
STOP={'every','all','any','each','exist','exists','least','one','there','who','whom','whose','will','would','also','both','either','neither','a','an','the','of','to','in','on','at','for','and','or','that','this','their','its','it','they','them',
